...
printer) flat on the work surface of the machine and adjusted its
z-height to match what the factory said was the focal point of the
laser.
...
make a local copy of that file with the `local.fixup.cor` name.
